...
<head>
	...
	<title>Web app</title>
	<link rel="stylesheet" href="<%=request.getContextPath()%>/css/screen.css" type="text/css" media="screen, projection"></link>
	<link rel="stylesheet" href="<%=request.getContextPath()%>/css/print.css" type="text/css" media="print"></link>
	<!--[if IE]>
...
<body>
	<div class="container" style="border: #C1C1C1 solid 1px; border-radius:10px;">
		...
		<div class="span-25"><tiles:insertAttribute name="navMenu"/>
		</div>
		<!-- Menu Page -->
